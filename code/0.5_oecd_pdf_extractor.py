"""
Social Corpus — OECD Guidelines PDF Extractor
==============================================

Extract and clean text from the OECD Guidelines for Multinational
Enterprises PDF for use as the S corpus.
...
Output
------
    data/interim/Text corpus/S/OECD_Guidelines.txt

Usage
-----
    python code/0.5_oecd_pdf_extractor.py
