"""
Extract Firm Identifiers
========================

Extract unique firm identifiers (gvkey, permno) from the earnings call
overview CSV into separate output files.
...
Usage
-----
    python code/0.1_extract_gvkeys.py
...
OVERVIEW_CSV  = PROJECT_ROOT / "data" / "raw" / "list_earnings_calls_group_project_upload.csv"
