"""
Governance Corpus — PDF Extractor
==================================

Extract and clean text from the G20/OECD Principles of Corporate
Governance PDF for use as the G corpus.

Input
-----
    data/external/Text corpus/G/OECD_Corporate Governance Principles.pdf

Output
------
    data/interim/Text corpus/G/OECD_Corporate_Governance_Principles.txt

Usage
-----
    python code/0.3_governance_pdf_extractor.py
