"""
Compute ESG Talk Scores
========================

Compute per-transcript ESG cosine-similarity scores (e_talk, s_talk,
g_talk) for each of the three segment sets: combined, pres, answers.
