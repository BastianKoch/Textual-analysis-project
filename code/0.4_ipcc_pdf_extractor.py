"""
Environment Corpus — IPCC PDF Extractor
========================================

Extract and clean text from the IPCC AR6 Synthesis Report Full Volume
PDF for use as the E corpus.

Input
-----
    data/external/Text corpus/E/IPCC_AR6_SYR_FullVolume.pdf

Output
------
    data/interim/Text corpus/E/IPCC_AR6_SYR_FullVolume.txt

Usage
-----
    python code/0.4_ipcc_pdf_extractor.py
