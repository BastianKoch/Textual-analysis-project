"""
Build Earnings Call Bigrams
============================

For every normalized segment file in data/processed/Transcripts/
(presentation, answers, questions) build a list of consecutive word
bigrams and write them — one per line, space-separated — to
data/interim/bigrams/.

Input
-----
    data/processed/Transcripts/{year}/*_{segment}.txt
...
Usage
-----
    python code/1.1_build_earnings_calls_bigrams.py          # all segments
    python code/1.1_build_earnings_calls_bigrams.py pres     # presentation only
