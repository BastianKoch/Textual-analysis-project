"""
Normalize ESG Reference Corpora
================================

Apply the standard NLP normalization pipeline to every E/S/G corpus
text file:
...
Input
-----
    data/interim/Text corpus/{E,S,G}/*.txt
...
Usage
-----
    python code/0.6_corpora_processing.py
